...
VirtualHost "droidko.com"
	...
	-- use the global one.
	ssl = {
		key = "/etc/prosody/certs/droidko.com.key";
		certificate = "/etc/prosody/certs/droidko.com.crt";
	}
...
Component "conference.droidko.com" "muc"

-- Set up a SOCKS5 bytestream proxy for server-proxied file transfers:
Component "proxy.droidko.com" "proxy65"
